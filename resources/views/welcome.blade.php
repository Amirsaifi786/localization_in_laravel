...
<body>
    <main class="">
      ...
      <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
        <li><a href="#" class="nav-link px-2 link-secondary">{{ __('home.title') }}</a></li>
        <li><a href="#" class="nav-link px-2">{{ __('home.Features') }}</a></li>
        <li><a href="#" class="nav-link px-2">{{ __('home.Pricing') }}</a></li>
        <li><a href="#" class="nav-link px-2">{{ __('home.FAQs') }}</a></li>
        <li><a href="#" class="nav-link px-2">{{ __('home.About') }}</a></li>
      </ul>
      ...
      <div class="col-md-1 text-end">
        ...
        <select class="changeLang form-select">
           ...
           <option value="ur" {{ session()->get('locale') == 'ur' ? 'selected' : '' }}> {{ __('home.Urdu') }}
            </option>          
        </select>
      </div>
    </header>
